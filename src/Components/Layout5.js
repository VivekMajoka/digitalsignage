...
import I1 from '../Assets/v1/I1.jpg'
import I2 from '../Assets/v1/I2.jpg'
import I3 from '../Assets/v1/I3.jpg'
import I4 from '../Assets/v1/I4.jpg'
                ...
                <div className="bodyform1">
                    ...
                    <div style={{ width: "75%", flexDirection: "column", display: "flex", height: window.innerHeight, position: "fixed", right: 0, paddingLeft: "10%", paddingRight: "10%" }}>
                        <div style={{ width: "100%", height: "25%" }}>
                            <img style={{ width: "100%", height: "100%" }} src={I1} />
                        </div>
                        <div style={{ width: "100%", height: "25%" }}>
                            <img style={{ width: "100%", height: "100%" }} src={I2} />
                        </div>
                        <div style={{ width: "100%", height: "25%", flexDirection: "row", display: "flex" }}>
                            <div style={{ width: "50%", height: "100%" }}>
                                <img style={{ width: "100%", height: "100%" }} src={I3} />
                            </div>
                            <div style={{ width: "50%", height: "100%" }}>
                                <img style={{ width: "100%", height: "100%" }} src={I4} />
                            </div>
                        </div>
                        <div style={{ width: "100%", height: "25%", justifyContent: "center", alignItems: "center", display: "flex", background: "white" }}>
                            <div style={{ width: "90%", height: "90%" }}>
                                <div style={{ width: "100%", height: "20%", backgroundColor: "grey", flexDirection: "row", display: "flex" }}>
                                    <div style={{ width: "25%", height: "100%", justifyContent: "center", alignItems: "center" }}>
